...
aws cloudformation delete-stack --stack-name aws101-application-service
aws cloudformation wait stack-delete-complete --stack-name aws101-application-service
