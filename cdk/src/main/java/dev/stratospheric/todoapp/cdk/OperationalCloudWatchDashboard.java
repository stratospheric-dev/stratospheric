...
public class OperationalCloudWatchDashboard extends Construct {
  ...
  public OperationalCloudWatchDashboard(
    ...
    new Dashboard(this, "operationalSpringBootApplicationDashboard", DashboardProps.builder()
      .dashboardName(applicationEnvironment + "-operational-application-dashboard")
      .widgets(List.of(
        List.of(
          TextWidget.Builder
            .create()
